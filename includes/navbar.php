<body class="menu">
	...
	<div class="container-fluid py-3 px-4">
		<div class="row d-flex align-items-center py-3">
			<div class="col-xl-4 col-lg-4 col-md-4 col-0 d-xl-block d-lg-block d-md-block d-none">
				<form class="form-goup d-flex">
					<input class="form-control me-2" type="search" placeholder="Search" aria-label="Search">
                	<button class="btn btn-outline-none" type="submit"><i class="fa-solid fa-magnifying-glass"></i></button>
				</form>
			</div>
