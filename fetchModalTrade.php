	...
	if(isset($_POST['prod_id']) && $_POST['function'] == "view_products"){
		...
		<div class="modal-content">
	      <div class="modal-header">
	        <h1 class="modal-title fs-5" id="exampleModalLabel">Brand Name (Product Type)</h1>
        					...
        					<div class="row">
					        		...
					        		<div class="col-xl-8 col-lg-8 col-md-12 col-12 shadow-sm rounded">
					        			<div class="py-2">
					        				...
					        				<h6 class="mb-0">Expected Trade: </h6><?=$fetch_info['trade_expected_trade']?>
					        				<h6 class="mb-0">Duration Date: </h6><?=$fetch_info['trade_duration_date']?>
					        				<h6 class="mb-0">Contact:</h6><?=$fetch_info['product_contact']?>
					        				<h6 class="mb-0">Address:</h6><?=$fetch_info['product_address']?>
					        				<h6 class="mb-0">Status: <span class="bg-success px-1 text-white rounded"><?=$fetch_info['product_availability']?></span></h6>
					        			</div>
					        		</div>
