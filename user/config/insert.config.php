...
class insert extends controller{
	public function addProduct($categories_product, $product_image, $product_type,$carrier_product_name, $carrier_cap ,$trade_product_name, $trade_expected_trade, $trade_duration_date){
		$stmt = $this->add_product($categories_product, $product_image, $product_type,$carrier_product_name, $carrier_cap ,$trade_product_name, $trade_expected_trade, $trade_duration_date);
